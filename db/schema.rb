...
ActiveRecord::Schema[7.0].define(version: 2022_08_02_180653) do
  ...
  create_table "list_sections", force: :cascade do |t|
    t.string "title"
    t.json "list"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "sections", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["referenced_id"], name: "index_sections_on_referenced_id"
    t.index ["referencer_id"], name: "index_sections_on_referencer_id"
  ...
  create_table "templates", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["organisation_id"], name: "index_templates_on_organisation_id"
  ...
  add_foreign_key "comments", "templates"
  ...
  add_foreign_key "templates", "organisations"
